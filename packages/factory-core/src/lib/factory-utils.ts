/*
<MODULE_CONTRACT>
<purpose>Provides utility functions for managing paths in factory pipeline applications.</purpose>
<non-goals>
  <item>Does not handle file content manipulation or I/O operations.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Moved from @syrokomskyi/observatory-core to @syrokomskyi/factory-core — factory path utilities belong with factory code.</item>
</CHANGE_SUMMARY>
*/

/**
 * Factory-wide utility functions for factory pipeline apps.
 *
