...
### Added
- Add AGENTS.md files to all apps and packages to document agent usage and roles.
- Add changelog links to all README.md files for improved release visibility.
- Generate CHANGELOG.md for all packages and apps to provide comprehensive release history.

### Changed
- Migrate forge dependency from @webgogol/forge to @warpgogol/forge across all projects.
- Rename @wgogol/changelog-live to @warpgogol/changelog-live for consistency with the new namespace.
- Bump various dependencies including typescript, eslint, @playwright/test, commander, openai, @anthropic-ai/sdk, jsdom, write-file-atomic, @types/better-sqlite3, @tanstack/table-core, @swc/core, @swc/helpers, @swc-node/register, @warpgogol/forge, cross-env, jiti, and turbo to latest versions.
- Upgrade jose, tsx, typescript-eslint, csv-parse/stringify, undici, verdaccio, and forge dependencies to latest releases.

### Fixed
- Downgrade TypeScript from 7.0.2 to 6.0.3 to ensure compatibility with typescript-eslint.

### Documentation
- Update multiple SKILL.md files and learned-principles.md for agent- and forge-related documentation.
- Update AGENTS.md and README.md for changelog-live to reflect new package naming.

## 2026-07-23 .. 2026-07-29

### Added
- Restore missing package.json files for multiple apps and packages to fix dependency issues
- Align Vitest versions across workspaces for consistent testing
- Add merged AGENTS.md and a new README.md file for improved project documentation

### Changed
- Upgrade dependencies across the workspace for apps and packages
- Flatten project structure by moving apps/source/* contents to the repository root

### Fixed
- Correct various package restoration issues and resolve alignment of dependency versions

### Removed
- Remove all traces of code-compass from devDependencies and scripts in package.json files
- Delete legacy apps/source directory, all nested files, and obsolete documentation

### Documentation
- Merge and update agent documentation and introduce README.md
