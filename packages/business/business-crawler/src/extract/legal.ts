/*
<MODULE_CONTRACT>
<purpose>This module extracts specific legal page links from HTML content based on predefined keyword matches.</purpose>
<non-goals>
  <item>This module does not perform any HTML content modification or generation.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of legal link extraction functions using keyword matching.</item>
</CHANGE_SUMMARY>
*/
...
export const extractWiderrufPage = (
  html: string | CheerioAPI,
  baseUrl: string,
): LinkPresenceResult => extractLegalLink(html, baseUrl, WIDERRUF_KEYWORDS);

export const extractVersandPage = (
  html: string | CheerioAPI,
  baseUrl: string,
): LinkPresenceResult => extractLegalLink(html, baseUrl, VERSAND_KEYWORDS);
