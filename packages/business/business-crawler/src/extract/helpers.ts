/*
<MODULE_CONTRACT>
<purpose>This module provides utility functions for processing HTML content, including keyword matching, URL resolution, and schema.org type extraction.</purpose>
<non-goals>
  <item>This module does not perform any network requests or HTML fetching.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of utility functions for HTML content processing.</item>
</CHANGE_SUMMARY>
*/
...
export type LinkPresenceResult = {
  present: boolean;
  url: string | null;
...
export const normalizeMatchText = (s: string): string => s.toLowerCase().replace(/[\s\-_/]/g, "");
  ...
  const collect = (obj: unknown): void => {
    ...
    if (obj && typeof obj === "object") {
      ...
      if (typeof t === "string") types.add(t.toLowerCase());
        ...
        t.forEach((v) => {
          if (typeof v === "string") types.add(v.toLowerCase());
        });
