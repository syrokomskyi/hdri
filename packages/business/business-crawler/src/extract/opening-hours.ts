/*
<MODULE_CONTRACT>
<purpose>This module extracts and returns the opening hours from a given HTML page using JSON-LD structured data and text heuristics.</purpose>
<non-goals>
  <item>This module does not validate the correctness of the extracted opening hours.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of opening hours extraction using JSON-LD and text heuristics.</item>
</CHANGE_SUMMARY>
*/
...
export const extractOpeningHours = (html: string | CheerioAPI): OpeningHoursResult => {
  ...
  $('script[type="application/ld+json"]').each((_i, el) => {
    ...
    try {
      ...
      if (hours) {
        foundText = Array.isArray(hours) ? hours.join(", ") : String(hours).slice(0, 500);
        return false;
      }
    } catch {
      // invalid JSON — skip
