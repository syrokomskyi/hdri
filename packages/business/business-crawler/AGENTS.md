...
# `@syrokomskyi/business-crawler` — Agent Guide
...
| Entry point | Module |
| --- | --- |
| `@syrokomskyi/business-crawler/package.json` | `./package.json` |
| `@syrokomskyi/business-crawler` | `./dist/index.d.ts` |
| `@syrokomskyi/business-crawler/liveness` | `./dist/liveness.d.ts` |
| `@syrokomskyi/business-crawler/fetch-page` | `./dist/fetch-page.d.ts` |
| `@syrokomskyi/business-crawler/extract` | `./dist/extract.d.ts` |
| `@syrokomskyi/business-crawler/robots-honor` | `./dist/robots-honor.d.ts` |
