/*
<MODULE_CONTRACT>
<purpose>This module defines and manages several SQLite tables for domain registry and related data, including site information, source seeds, cohorts, strata, consent events, and HWO mappings.</purpose>
<non-goals>
  <item>This module does not handle the actual database connections or query execution.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Added detailed comments and structure for each table definition.</item>
</CHANGE_SUMMARY>
*/
...
export const siteSourceSeeds = sqliteTable(
  "site_source_seeds",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
  ...
  (t) => ({
    uniq: uniqueIndex("sss_site_source_item").on(t.siteId, t.sourcePath, t.sourceItemKey),
...
// Not defined here — see packages/business/business-core/src/migrate/pages.ts.
...
export const siteStrata = sqliteTable(
  "site_strata",
  {
...
export const siteHwoMappings = sqliteTable(
  "site_hwo_mappings",
  {
    siteId: integer("site_id").notNull(),
