/*
<MODULE_CONTRACT>
<purpose>This module defines database schemas for managing site pages, page contents, observations, and extracted data using SQLite.</purpose>
<non-goals>
  <item>This module does not handle database connection or query execution logic.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of database schema definitions for site-related data management.</item>
</CHANGE_SUMMARY>
*/
...
export const pageObservations = sqliteTable(
  "page_observations",
  {
...
export const contentExtractions = sqliteTable(
  "content_extractions",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    contentSha256: text("content_sha256").notNull(),
...
export const contentContacts = sqliteTable(
  "content_contacts",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
...
export const extPhone = sqliteTable(
  "ext_phone",
  {
    contentSha256: text("content_sha256").notNull(),
    extractorVer: text("extractor_ver").notNull(),
...
export const extEmail = sqliteTable(
  "ext_email",
  {
    contentSha256: text("content_sha256").notNull(),
    extractorVer: text("extractor_ver").notNull(),
