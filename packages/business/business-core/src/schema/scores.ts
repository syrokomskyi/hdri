/*
<MODULE_CONTRACT>
<purpose>This module defines and exports SQLite table schemas for scoring data, including scores, score dimensions, score indicator traces, and manual reviews, to support the scoring and auditing processes.</purpose>
<non-goals>
  <item>This module does not handle database connections or query execution.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of table schemas for scores, score dimensions, score indicator traces, and manual reviews.</item>
</CHANGE_SUMMARY>
*/
...
export const scoreDimensions = sqliteTable(
  "score_dimensions",
  {
    scoringRunId: text("scoring_run_id").notNull(),
    siteId: integer("site_id").notNull(),
...
export const scoreIndicatorTraces = sqliteTable(
  "score_indicator_traces",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    scoringRunId: text("scoring_run_id").notNull(),
    siteId: integer("site_id").notNull(),
