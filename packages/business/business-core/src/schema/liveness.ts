/*
<MODULE_CONTRACT>
<purpose>This module defines a SQLite table for storing HTTP availability results per domain, including metadata such as HTTP status, redirect information, and error details.</purpose>
<non-goals>
  <item>This module does not perform the actual HTTP checks or network requests.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of the liveness_checks table schema with indexing and type definitions.</item>
</CHANGE_SUMMARY>
*/
...
export const livenessChecks = sqliteTable(
  "liveness_checks",
  {
