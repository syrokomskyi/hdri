/*
<MODULE_CONTRACT>
<purpose>This module defines database tables for auditing tools, including audit runs, lighthouse runs, and axe runs, using the drizzle-orm library.</purpose>
<non-goals>
  <item>This module does not execute any database operations or queries.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of database table definitions for audit runs, lighthouse runs, and axe runs.</item>
</CHANGE_SUMMARY>
*/
