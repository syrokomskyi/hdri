/*
<MODULE_CONTRACT>
<purpose>This module defines types and interfaces for the HWO classification system, which is based on the official German Handwerksordnung master dataset and mapping systems.</purpose>
<non-goals>
  <item>This module does not implement any logic for processing or manipulating HWO data.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of types and interfaces for HWO classification and mapping systems.</item>
</CHANGE_SUMMARY>
*/
