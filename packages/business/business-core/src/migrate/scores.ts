/*
<MODULE_CONTRACT>
<purpose>This module manages database schema migrations and metadata stamping for the hdri-scores.db, ensuring the correct structure for storing scores, dimensions, audit traces, and provenance data.</purpose>
<non-goals>
  <item>This module does not handle database connection management or query execution beyond schema setup.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial setup of database tables and indices for scores, dimensions, audit traces, manual reviews, and pipeline inputs.</item>
</CHANGE_SUMMARY>
*/

import type Database from "better-sqlite3";
export { stampSchemaMeta as stampScoresMeta } from "../schema/schema-meta.js";
