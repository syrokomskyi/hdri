...
# `@syrokomskyi/pipeline-ai` — Agent Guide
...
| Entry point | Module |
| --- | --- |
| `@syrokomskyi/pipeline-ai/package.json` | `./package.json` |
| `@syrokomskyi/pipeline-ai` | `./src/index.ts` |
| `@syrokomskyi/pipeline-ai/json` | `./src/lib/normalize-ai-json.ts` |
| `@syrokomskyi/pipeline-ai/openai` | `./src/lib/openai.ts` |
