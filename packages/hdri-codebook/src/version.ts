/*
<MODULE_CONTRACT>
<purpose>Handles semantic versioning for codebooks, enabling version parsing, formatting, and compatibility checks.</purpose>
<non-goals>
  <item>Does not manage codebook content or data storage.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of version parsing and compatibility functions.</item>
</CHANGE_SUMMARY>
*/
