/*
<MODULE_CONTRACT>
<purpose>This module provides functionality to aggregate and summarize site scores based on various dimensions and axes.</purpose>
<non-goals>
  <item>This module does not perform any data fetching or persistence operations.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of site score aggregation and summarization functions.</item>
</CHANGE_SUMMARY>
*/
...
const sortedCopy = (xs: readonly number[]): number[] => xs.slice().sort((a, b) => a - b);
