...
### Added
- Add links to changelog files in all README.md files across packages and apps.
- Generate initial CHANGELOG.md files for all packages and applications.
- Introduce new AGENTS.md documentation describing agents in all relevant packages and apps.

### Changed
- Rename @wgogol/changelog-live to @warpgogol/changelog-live throughout the repository.
- Update AGENTS.md documentation in all packages and apps per RFC-0070 step 16.
- Bump and update various dependencies, including tsx, jose, typescript-eslint, csv-parse/stringify, pg-boss, undici, verdaccio, @aws-sdk/client-s3, TypeScript, eslint, commander, openai, @anthropic-ai/sdk, jsdom, write-file-atomic, @types/better-sqlite3, @tanstack/table-core, @swc/core, @swc/helpers, @swc-node/register, @warpgogol/forge, cross-env, jiti, turbo, better-sqlite3, csv-stringify, jsonc-eslint-parser, and others.
...
### Documentation
- Update all AGENTS.md files to reflect RFC-0070 changes.

## 2026-07-23 .. 2026-07-29

### Added
- Add missing package.json files and README.md to restored structure.

### Changed
- Upgrade dependencies across the workspace to latest versions.
- Align Vitest versions across all packages for consistency.
- Flatten project structure by moving apps/source/* to the repository root.

### Fixed
- Restore missing package.json files and merge AGENTS.md updates.

### Removed
- Remove code-compass from all devDependencies and scripts.
- Remove obsolete scoring-rules.ts shim from hdri-codebook.
- Delete legacy apps/source directory, associated files, and redundant documentation.

### Documentation
- Add and update project documentation, including AGENTS.md and project-narrative.md.
