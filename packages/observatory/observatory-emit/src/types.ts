/*
<MODULE_CONTRACT>
<purpose>Defines the data structures for emit-bundles, facilitating the exchange between factory applications and the digital observatory.</purpose>
<non-goals>
  <item>Does not handle the actual reading or writing of the emit-bundle files.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial definition of emit-bundle types and their schemas.</item>
</CHANGE_SUMMARY>
*/

/**
 * Emit-bundle types — the formal handoff contract between a factory app and
 * the observatory. Every factory app writes one emit-bundle per run;
 ...
 * @syrokomskyi/observatory-vault when DuckDB is available).
 */
