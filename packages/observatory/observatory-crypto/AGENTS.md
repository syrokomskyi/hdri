...
# `@syrokomskyi/observatory-crypto` — Agent Guide
...
| Entry point | Module |
| --- | --- |
| `@syrokomskyi/observatory-crypto/package.json` | `./package.json` |
| `@syrokomskyi/observatory-crypto` | `./src/index.ts` |
| `@syrokomskyi/observatory-crypto/auto-env` | `./src/auto-env.ts` |
