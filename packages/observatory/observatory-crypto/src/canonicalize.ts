/*
<MODULE_CONTRACT>
<purpose>Implements JSON Canonicalization Scheme (JCS) to produce a consistent JSON string representation.</purpose>
<non-goals>
  <item>Does not handle non-finite numbers such as NaN or Infinity.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of JSON canonicalization based on RFC 8785.</item>
</CHANGE_SUMMARY>
*/
