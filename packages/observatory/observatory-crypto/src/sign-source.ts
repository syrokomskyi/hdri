/*
<MODULE_CONTRACT>
<purpose>Generates and verifies batch-level ed25519 signatures for app data snapshots, ensuring data integrity and authenticity.</purpose>
<non-goals>
  <item>Does not handle per-observation signing, which is managed by a different module.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of source signature generation and verification.</item>
</CHANGE_SUMMARY>
*/
