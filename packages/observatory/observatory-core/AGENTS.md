...
# `@syrokomskyi/observatory-core` — Agent Guide
...
| Entry point | Module |
| --- | --- |
| `@syrokomskyi/observatory-core/package.json` | `./package.json` |
| `@syrokomskyi/observatory-core` | `./src/index.ts` |
| `@syrokomskyi/observatory-core/ontology` | `./src/ontology/index.ts` |
| `@syrokomskyi/observatory-core/hashing` | `./src/hashing.ts` |
