/*
<MODULE_CONTRACT>
<purpose>Defines types for signal ontology, facilitating structured communication between data collectors and consumers.</purpose>
<non-goals>
  <item>Does not implement signal extraction logic or data processing algorithms.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial definition of signal ontology types and structures.</item>
</CHANGE_SUMMARY>
*/
