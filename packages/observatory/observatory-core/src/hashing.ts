/*
<MODULE_CONTRACT>
<purpose>Provides deterministic hashing utilities for observatory data, ensuring consistent results for provenance and deduplication tasks.</purpose>
<non-goals>
  <item>Does not handle non-JSON-serializable data types.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial implementation of deterministic hashing functions using SHA-256.</item>
</CHANGE_SUMMARY>
*/
 ...
 */
export const sha256Json = (value: unknown): string => sha256(stableStringify(value));
