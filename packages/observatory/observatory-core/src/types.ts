/*
<MODULE_CONTRACT>
<purpose>Defines canonical type structures for modeling Digital Observatory data architecture across four layers: Evidence, Observations, Interpretations, and Narrative.</purpose>
<non-goals>
  <item>Does not implement data processing logic or algorithms.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation of type definitions for observatory-core.</item>
  <item>Re-export ObservationValueType from value.ts — invariant now owned by one module.</item>
</CHANGE_SUMMARY>
*/
 ...
 * spec/011-020/13-observatory/1-concept.md. They cover the four
...
// ---------------------------------------------------------------------------
// Value types for observations — owned by value.ts
// ---------------------------------------------------------------------------

import type { ObservationValueType } from "./value.js";
export type { ObservationValueType } from "./value.js";
 ...
 * scores zero).
 */
export type SignalCollectionStatus = "absent" | "unreachable" | "forbidden" | "not_applicable";

/** Reason for deprecation. */
export type DeprecatedReason = "domain_parked" | "false_positive" | "pipeline_error" | string;
