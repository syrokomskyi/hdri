...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](LICENSE) [![CI](https://img.shields.io/github/actions/workflow/status/syrokomskyi/hdri/ci.yml?logo=github-actions&logoColor=white)](https://github.com/syrokomskyi/hdri/actions) [![Issues](https://img.shields.io/github/issues/syrokomskyi/hdri?logo=github&logoColor=white)](https://github.com/syrokomskyi/hdri/issues) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20478155.svg)](https://doi.org/10.5281/zenodo.20478155)
...
2. **Observatory** ([`apps/hdri/observatory`](apps/hdri/observatory/README.md)) — maps raw signals to an ontology, scores them with a configurable codebook, and builds privacy-safe data marts.
...
apps/
  ...
  observatory/      longitudinal scoring & cohort analysis
  dashboard/           public Astro dashboard
...
packages/
  ...
  factory-core/        factory-specific shared logic
  observatory-core/         ontology, observations, asset IDs, validation
  ...
  rate-limit/               rate limiting, concurrency gates & retry
...
- [`apps/hdri/observatory`](apps/hdri/observatory/README.md) — score signals and build cohorts
