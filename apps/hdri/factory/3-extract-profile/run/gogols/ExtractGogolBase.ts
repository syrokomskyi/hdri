/*
<MODULE_CONTRACT>
<purpose>Base class for focused single-signal extraction gogols — this module handles extract gogol base operations within the pipeline application.</purpose>
<non-goals>
  <item>Does not perform network fetches — that is CrawlGogol's responsibility.</item>
  <item>Does not define per-signal extraction rules — those live in @syrokomskyi/business-crawler/extract.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
