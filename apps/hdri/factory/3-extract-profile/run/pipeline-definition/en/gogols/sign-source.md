...
title: Sign source
purpose: >-
  Create cryptographic signature over pages-YYYY-qN.db file hash for downstream
  verification and traceability.
details: >-
  Computes SHA-256 hash of the final pages-YYYY-qN.db file. Creates ed25519
...
definitionOfDone:
  - SHA-256 of pages-YYYY-qN.db computed
