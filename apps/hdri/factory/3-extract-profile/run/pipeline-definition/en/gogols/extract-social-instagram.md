---
factory: extract-social-instagram
title: Extract Social Instagram Link
purpose: >-
  Detect Instagram profile links on crawled pages.
details: >-
  Scans all <a href> elements for outbound links whose hostname matches
  instagram.com. No HTTP requests are made.
  Writes one row per content_sha256 to ext_social_instagram.
...
outputs:
  - ext_social_instagram rows in pages-YYYY-qN.db.
