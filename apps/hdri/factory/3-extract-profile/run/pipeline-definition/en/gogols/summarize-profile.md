...
details: >-
  Reads aggregate stats from pages-YYYY-qN.db (observations, unique content hashes,
  extraction counts, impressum/datenschutz/cookie/copyright year breakdowns, contact counts),
  then streams pages-YYYY-qN.db through a SHA-256 hash. Writes profile-snapshot.json
...
inputs:
  - pages-YYYY-qN.db (fully populated by crawl-pages and extract-* gogols).
outputs:
