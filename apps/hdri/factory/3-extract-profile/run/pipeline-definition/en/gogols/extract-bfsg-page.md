---
factory: extract-bfsg-page
title: Extract BFSG Accessibility Statement
purpose: >-
  Detect Barrierefreiheitserklärung (BFSG / accessibility statement) links on crawled pages.
details: >-
  Scans all <a href> elements for keywords: barrierefreiheit, bfsg,
  accessibility-statement, barrierefreiheitserklaerung, etc. Uses url_norm from
  registry.db as baseUrl for relative href resolution. Writes one row per
  content_sha256 to ext_bfsg_page with url and confidence.
...
outputs:
  - ext_bfsg_page rows in pages-YYYY-qN.db.
