---
factory: extract-social-youtube
title: Extract Social YouTube Link
purpose: >-
  Detect YouTube channel links on crawled pages.
details: >-
  Scans all <a href> elements for outbound links whose hostname matches
  youtube.com or youtu.be. No HTTP requests are made.
  Writes one row per content_sha256 to ext_social_youtube.
...
outputs:
  - ext_social_youtube rows in pages-YYYY-qN.db.
