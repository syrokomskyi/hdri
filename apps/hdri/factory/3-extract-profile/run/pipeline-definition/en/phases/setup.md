...
purpose: >-
  Idempotently initialise pages-YYYY-qN.db and verify upstream signatures before any
  crawling begins.
entryCriteria:
...
successSignals:
  - pages-YYYY-qN.db is created with the correct schema and _schema_meta stamped.
