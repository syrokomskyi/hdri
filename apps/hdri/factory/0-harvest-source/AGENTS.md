...
# `@syrokomskyi/catalog-harvest` — Agent Guide
...
| Script | Command |
| --- | --- |
| `build` | `pnpm --dir ../../../.. exec tsc -b apps/hdri/factory/0-harvest-source/tsconfig.json --pretty false` |
| `typecheck` | `pnpm --dir ../../../.. exec tsc -b apps/hdri/factory/0-harvest-source/tsconfig.json --pretty false` |
| `dev` | `tsx -C @syrokomskyi/source watch run/run.ts` |
| `start` | `tsx -C @syrokomskyi/source run/run.ts` |
| `test` | `pnpm --dir ../../../.. exec vitest run --config apps/hdri/factory/0-harvest-source/vitest.config.ts` |
