...
title: Sign source
purpose: >-
  Create cryptographic signature over lighthouse_YYYY.db file hash for downstream
  verification and traceability.
details: >-
  Computes SHA-256 hash of the final lighthouse_YYYY.db file. Creates ed25519
