...
purpose: >-
  ...
  initialise lighthouse-YYYY-qN.db with audit infrastructure.
entryCriteria:
  - The output root directory is writable.
successSignals:
  - environment-profile.json captures hardware, OS, and tool versions.
  - lighthouse-YYYY-qN.db is created with audit_runs, lighthouse_runs tables and _schema_meta stamped.
exitCriteria:
