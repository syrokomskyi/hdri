...
<CHANGE_SUMMARY>
  ...
  <item>Add COMPASS scaffolding to registry file.</item>
  <item>Remove lighthouse gogols from registry - this app is Axe-only.</item>
  <item>Phase B cleanup: remove load-audit-cohort and axe-audit-by-bundesland gogols.</item>
</CHANGE_SUMMARY>
*/
...
import { AxeAuditGogol } from "../gogols/AxeAuditGogol.js";
