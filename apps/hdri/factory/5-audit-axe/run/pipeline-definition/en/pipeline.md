...
quickStart:
  ...
  - Run the pipeline; raw tool reports land in data/audit-reports/axe/{sha[0:2]}/{sha}.json and aggregates in .output/data/db/axe-YYYY-qN.db.
  - The final axe-YYYY-qN.db snapshot is the data contract for downstream dashboards.
operatingRules:
  ...
  - Upstream DB snapshot SHA-256s (registry.db + axe-YYYY-qN.db) are recorded in the final snapshot for DSGVO / peer-review audit.
members:
  - setup
  - audit
---
