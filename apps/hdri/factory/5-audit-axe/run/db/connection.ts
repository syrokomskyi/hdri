/*
<MODULE_CONTRACT>
<purpose>SQLite database connection helpers for the axe audit pipeline — this module handles connection operations within the pipeline application.</purpose>
<non-goals>
