...
Initialises the pipeline run, assigns run_id, and prepares the observatory DB. Asset states are ingested during the Observe phase from the factory emit-bundle.
