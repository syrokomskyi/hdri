/*
<MODULE_CONTRACT>
<purpose>This module provides a centralized glossary for terms, ensuring a single source of truth for definitions and links, and supporting both inline and standalone page rendering.</purpose>
<non-goals>
  <item>This module does not handle the creation or management of glossary terms outside of the predefined list.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
...
export type GlossaryEntry = {
  ...
  category: "Statistik" | "Datenschutz" | "Index" | "Recht & Technik" | "Methodik";
...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    long: "Berechnung via linearer Interpolation (Type 7, R-Standard): pos = (n − 1) × 0,75. Im Gegensatz zum Mittelwert wird P75 nicht von Einzelwerten verzerrt.",
    links: [
      { label: "Methodik: Warum P75", href: "/methodik" },
      {
        label: "Quantil / Perzentil (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Quantil",
        external: true,
      },
    ],
  },
  {
    ...
    links: [
      { label: "Median (Wikipedia)", href: "https://de.wikipedia.org/wiki/Median", external: true },
    ],
  },
  {
    id: "mittelwert",
    ...
    links: [
      {
        label: "Arithmetisches Mittel (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Arithmetisches_Mittel",
        external: true,
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: "Interquartilsabstand (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Interquartilsabstand",
        external: true,
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "Quartil (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Quartil",
        external: true,
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: "Deskriptive Statistik (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Deskriptive_Statistik",
        external: true,
      },
    ],
  },
  {
    ...
    category: "Statistik",
    short:
      "Die Menge der in einem Quartal ausgewerteten Websites. N gibt die Fallzahl an. Veröffentlicht werden nur Aggregate, deren Fallzahl die Publikationsschwelle erfüllt.",
    links: [
      {
        label: "Stichprobe (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/Stichprobe",
        external: true,
      },
    ],
  },
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "k-Anonymität (Wikipedia)",
        href: "https://de.wikipedia.org/wiki/K-Anonymit%C3%A4t",
        external: true,
      },
    ],
  },
  {
    ...
    long: "Gründe u. a.: delta_below_absolute_threshold, delta_below_relative_threshold, current/previous_sample_below_k, category_absent. Dies ist kein Fehler, sondern bewusster Schutz.",
    links: [
      { label: "Methodik: Delta-Suppression", href: "/methodik" },
      {
        label: "Statistical Disclosure Control (Wikipedia, EN)",
        href: "https://en.wikipedia.org/wiki/Statistical_disclosure_control",
        external: true,
      },
    ],
  },
  ...
  },
  {
    ...
    category: "Index",
    short:
      "Fünf Klassen, in die Websites anhand ihres HDRI-Scores gruppiert werden: Kritisch (0–<20), Basis (20–<40), Aufbau (40–<60), Fortgeschritten (60–<80), Vorbild (80–100). Zeigt die Verteilung der digitalen Reife über die Stichprobe.",
    links: [{ label: "Methodik: Reifegrad-Klassifizierung", href: "/methodik" }],
  },
  {
    id: "canonical",
    term: "Kanonischer Quartalsindex",
    aliases: ["kanonisch", "canonical", "canonical veröffentlicht", "kanonischer Index"],
    category: "Index",
    short:
      'Pro Quartal gibt es genau einen verbindlichen, „kanonischen" veröffentlichten Index. Nur diese kanonischen Quartale werden für Verlauf und Vergleiche verwendet — nicht Rohdaten einzelner Pipeline-Läufe.',
  ...
  },
  {
    ...
    links: [
      {
        label: "Anlage A (gesetze-im-internet.de)",
        href: "https://www.gesetze-im-internet.de/hwo/anlage_a.html",
        external: true,
      },
      {
        label: "Anlage B (gesetze-im-internet.de)",
        href: "https://www.gesetze-im-internet.de/hwo/anlage_b.html",
        external: true,
      },
    ],
  },
  ...
  },
  {
    ...
    links: [
      {
        label: "§ 5 DDG (gesetze-im-internet.de)",
  ...
  },
  {
    id: "pipeline",
    term: "Pipeline",
    aliases: ["Pipeline", "Erhebungs- und Auswertungspipeline"],
    category: "Index",
    short:
      "Der automatisierte Prozessablauf des HDRI: Erhebung, Registrierung, Signal-Extraktion, Scoring, Aggregation und Veröffentlichung. Jeder Quartalsdurchlauf folgt diesem festen Ablauf.",
    links: [{ label: "Methodik: Pipeline", href: "/methodik" }],
  },
  {
    id: "axe-core",
    term: "Axe-Core",
    aliases: ["Axe-Core", "axe-core", "Axe", "Deque"],
    category: "Recht & Technik",
    short:
      "Open-Source-Engine zur automatisierten Prüfung von WCAG-Konformität. Der HDRI nutzt Axe-Core, um Anzahl und Schweregrad von Barrierefreiheitsfehlern zu messen.",
    links: [
  ...
  },
  {
    id: "asset-id",
    term: "Asset-ID",
    aliases: ["Asset-ID", "Asset-IDs", "interne Kennung"],
    category: "Index",
    short:
      "Interne, eindeutige Kennung einer Website im HDRI-System. Wird bei der ersten Beobachtung einer Domain vergeben und nie veröffentlicht — das Dashboard zeigt ausschließlich Aggregate.",
    links: [{ label: "Methodik: Datenschutz", href: "/methodik" }],
  },
  {
    id: "barrierefreiheit",
    ...
    links: [
      {
        label: "WCAG 2.1 (deutsche Übersetzung, W3C)",
  ...
  {
    id: "berichtsperiode",
    term: "Berichtsperiode",
    aliases: ["Quartal", "Erfassungszeitraum", "Reporting Period"],
    category: "Index",
    short:
      "Der Zeitraum, für den ein HDRI-Index veröffentlicht wird. Berichtsperioden folgen dem Quartalsrhythmus (z. B. 2026-q2). Jede Periode hat einen eigenen Datensatz mit Manifest, Übersicht und Aggregaten.",
    links: [{ label: "Methodik: Pipeline", href: "/methodik" }],
  },
  {
    id: "codebook",
    term: "Codebook",
    aliases: ["Codebuch", "Scoring-Spezifikation"],
    category: "Methodik",
    short:
      "Die maschinenlesbare Spezifikation aller Dimensionen, Indikatoren, Gewichtungen, Scoring-Regeln und Missing-Value-Policies des HDRI. Das Codebook ist semantisch versioniert (MAJOR.MINOR.PATCH).",
    long: "Das Codebook liegt als YAML-Datei vor und ist die autoritative Quelle für die Berechnung des HDRI-Scores. Jeder veröffentlichte Index bezieht sich auf eine bestimmte Codebook-Version.",
    links: [
      { label: "Codebook-Seite", href: "/codebook" },
      { label: "Methodik: Scoring-Modell", href: "/methodik#scoring" },
    ],
  },
  {
    id: "observatory",
    term: "Digital Observatory",
    aliases: ["Observatory", "observatory"],
    category: "Index",
    short:
      "Die Verarbeitungs- und Veröffentlichungseinheit des HDRI. Das Observatory liest Emit-Bundles aus der Factory, validiert Ontologie, signiert Beobachtungen, speichert sie in einem Parquet-Vault, berechnet Scores und Aggregate und veröffentlicht nur Aggregate, die die Publikationsschwelle erfüllen.",
    links: [{ label: "Methodik: Pipeline", href: "/methodik" }],
  },
  {
    id: "extractor",
    term: "Extractor",
    aliases: ["Extraktor", "Extraktionsregel"],
    category: "Methodik",
    short:
      "Ein Modul, das einen rohen Signalwert aus HTML, strukturierten Daten oder Metadaten einer Website extrahiert. Jeder Indikator im Codebook verweist auf einen Extractor, der den Input-Key liefert.",
    links: [{ label: "Codebook: Indikatoren", href: "/codebook" }],
  },
  {
    id: "ontology",
    term: "Ontology",
    aliases: ["Ontologie", "Signal-Ontologie"],
    category: "Methodik",
    short:
      "Das formale Schema, das definiert, welche Signale im HDRI erfasst werden und wie sie heißen. Die Ontologie stellt sicher, dass Factory und Observatory dieselben Signalpfade verwenden.",
    links: [{ label: "Codebook: Ontology Ref", href: "/codebook" }],
  },
  {
    id: "signal",
    term: "Signal",
    aliases: ["Messsignal", "Datenpunkt"],
    category: "Methodik",
    short:
      "Ein einzelner, aus einer Website extrahierter Messwert (z. B. „Impressum vorhanden: true/false\u201c). Signale sind die Rohdaten, aus denen Indikator-Scores berechnet werden.",
    links: [{ label: "Methodik: Scoring-Modell", href: "/methodik#scoring" }],
  },
  {
    id: "bundesland",
    term: "Bundesland",
    ...
    category: "Index",
    short:
      "Eine regionale Gliederungsebene des HDRI. Aggregierte scores werden pro Bundesland veröffentlicht, sofern die Publikationsschwelle erfüllt ist.",
    links: [{ label: "Dashboard: Bundesländer-Vergleich", href: "/" }],
  },
  {
    id: "gewerbegruppe",
    term: "Gewerbegruppe",
    aliases: ["Gewerkgruppe", "Gewerkegruppe"],
    category: "Index",
    short:
      "Eine branchenbezogene Gliederungsebene des HDRI. Die sieben Gewerbegruppen (I-VII) entsprechen der offiziellen Einteilung des Statistischen Bundesamts (Destatis).",
    links: [{ label: "Dashboard: Gewerke-Vergleich", href: "/" }],
  },
];
