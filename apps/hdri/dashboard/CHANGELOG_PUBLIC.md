...
### Added
- Restored several missing configuration files to ensure all modules are up-to-date and function as expected, reducing future setup issues.

### Improved
- Upgraded underlying dependencies throughout the platform to enhance overall reliability and maintain compatibility with the latest ecosystem tools (EU-wide).
- Merged and updated internal documentation to provide more consistent project guidance for stakeholders and technical users.

### Fixed
- Aligned testing tool versions across multiple modules to avoid version conflicts and ensure smoother development and deployment processes.
- Flattened the project structure by moving app directories to the root, simplifying ongoing maintenance and improving clarity for contributors.
