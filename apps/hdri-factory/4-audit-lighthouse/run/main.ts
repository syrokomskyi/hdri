/*
<MODULE_CONTRACT>
<purpose>Main entry point for the 4-audit-lighthouse pipeline.</purpose>
<keywords>lighthouse, entry, pipeline</keywords>
<responsibilities>
...
<MODULE_MAP>
  <entry key="main.ts">Entry point that bootstraps the lighthouse audit pipeline via runApp.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
