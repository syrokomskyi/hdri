...
<responsibilities>
  ...
  <item>Specifies types for lighthouse audit pipeline steps and phases.</item>
...
<MODULE_MAP>
  ...
  <entry key="SiteDeepAuditPipelineStep">Represents a step in the deep audit pipeline (Lighthouse).</entry>
