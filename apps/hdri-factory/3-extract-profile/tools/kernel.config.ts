/*
<MODULE_CONTRACT>
<purpose>Facilitates the configuration of the GRACE tooling pipeline for site-profile documentation.</purpose>
<keywords>kernel, configuration, tooling</keywords>
<responsibilities>
  <item>Defines the site-profile specific GRACE kernel configuration.</item>
...
<CHANGE_SUMMARY>
  <item>Initial kernel configuration for site-profile GRACE compliance.</item>
</CHANGE_SUMMARY>
*/
...
export default defineKernelConfig({
  name: "site-profile",
  description: "Site Profile pipeline OS — GRACE documentation tooling",
  modules: [
    {
      name: "grace",
      version: "0.1.0",
