...
<keywords>extract, schema.org, LocalBusiness, JSON-LD, ext_schema_local_business</keywords>
<responsibilities>
  ...
  <item>Call extractSchemaLocalBusiness() and upsert one row per content_sha256 into ext_schema_local_business.</item>
...
<MODULE_MAP>
  <entry key="ExtractSchemaLocalBusinessGogol.run">Main extraction loop over page_observations for the current batch.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
...
import { extractSchemaLocalBusiness } from '@org/business-crawler/extract';
