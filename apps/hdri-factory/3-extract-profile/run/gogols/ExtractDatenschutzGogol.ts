...
<keywords>extract, datenschutz, privacy, compliance, DSGVO, ext_datenschutz</keywords>
<responsibilities>
  ...
  <item>Call extractDatenschutz() and upsert one row per content_sha256 into ext_datenschutz.</item>
...
<MODULE_MAP>
  <entry key="ExtractDatenschutzGogol.run">Main extraction loop over page_observations for the current batch.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
...
import { extractDatenschutz } from '@org/business-crawler/extract';
