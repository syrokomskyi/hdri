...
<keywords>extract, social, TikTok, ext_social_tiktok</keywords>
<responsibilities>
  ...
  <item>Call extractSocialTiktok() and upsert one row per content_sha256 into ext_social_tiktok.</item>
...
<MODULE_MAP>
  <entry key="ExtractSocialTiktokGogol.run">Main extraction loop over page_observations for the current batch.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
...
import { extractSocialTiktok } from '@org/business-crawler/extract';
