...
<keywords>extract, schema.org, Review, AggregateRating, JSON-LD, ext_schema_review</keywords>
<responsibilities>
  ...
  <item>Call extractSchemaReview() and upsert one row per content_sha256 into ext_schema_review.</item>
...
<MODULE_MAP>
  <entry key="ExtractSchemaReviewGogol.run">Main extraction loop over page_observations for the current batch.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
...
import { extractSchemaReview } from '@org/business-crawler/extract';
