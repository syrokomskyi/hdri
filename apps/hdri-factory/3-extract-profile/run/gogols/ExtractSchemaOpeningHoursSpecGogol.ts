...
<keywords>extract, schema.org, OpeningHoursSpecification, JSON-LD, ext_schema_opening_hours_spec</keywords>
<responsibilities>
  ...
  <item>Call extractSchemaOpeningHoursSpec() and upsert one row per content_sha256 into ext_schema_opening_hours_spec.</item>
...
<MODULE_MAP>
  <entry key="ExtractSchemaOpeningHoursSpecGogol.run">Main extraction loop over page_observations for the current batch.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
...
import { extractSchemaOpeningHoursSpec } from '@org/business-crawler/extract';
