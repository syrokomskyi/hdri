/*
<MODULE_CONTRACT>
<purpose>Main entry point for the 5-audit-axe pipeline.</purpose>
<keywords>axe, entry, pipeline</keywords>
<responsibilities>
...
<MODULE_MAP>
  <entry key="main.ts">Entry point that bootstraps the axe audit pipeline via runApp.</entry>
</MODULE_MAP>
<CHANGE_SUMMARY>
