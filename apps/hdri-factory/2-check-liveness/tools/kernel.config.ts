/*
<MODULE_CONTRACT>
<purpose>Facilitates the configuration of the GRACE tooling pipeline for site-liveness documentation.</purpose>
<keywords>kernel, configuration, tooling</keywords>
<responsibilities>
  <item>Defines the site-liveness specific GRACE kernel configuration.</item>
...
<CHANGE_SUMMARY>
  <item>Initial kernel configuration for site-liveness GRACE compliance.</item>
</CHANGE_SUMMARY>
*/
...
export default defineKernelConfig({
  name: "site-liveness",
  description: "Site Liveness pipeline OS — GRACE documentation tooling",
  modules: [
    {
      name: "grace",
      version: "0.1.0",
