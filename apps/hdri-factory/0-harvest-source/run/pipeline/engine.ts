...
<CHANGE_SUMMARY>
  <item>Added GRACE scaffolding to clarify module purpose and responsibilities.</item>
...
export const runPipelineEngine = createHdriFactoryEngine<PipelineState, PipelineContext, CatalogHarvestPipelineStep>(createPipelineContext);
