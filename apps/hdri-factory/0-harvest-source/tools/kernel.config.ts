/*
<MODULE_CONTRACT>
<purpose>Facilitates the configuration of the GRACE tooling pipeline for catalog-harvest documentation.</purpose>
<keywords>kernel, configuration, tooling</keywords>
<responsibilities>
  <item>Defines the catalog-harvest specific GRACE kernel configuration.</item>
...
<CHANGE_SUMMARY>
  <item>Initial kernel configuration for catalog-harvest GRACE compliance.</item>
</CHANGE_SUMMARY>
*/
...
export default defineKernelConfig({
  ...
  description: "Catalog Harvest pipeline OS — GRACE documentation tooling",
  modules: [
    {
      name: "grace",
      version: "0.1.0",
