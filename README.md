...
2. **Observatorium** ([`apps/hdri/observatory`](apps/hdri/observatory/README.md)) — Ordnet Rohsignale einer Ontologie zu, bewertet sie mit einem konfigurierbaren Codebook und erstellt datenschutzsichere Data Marts.
...
- [`apps/hdri/observatory`](apps/hdri/observatory/README.md) — Signale bewerten und Kohorten aufbauen
